...
const Header = ({ categories }: any) => {
  ...
  return (
    <header className="sticky top-0 z-20">
      {/* Top Nav */}
      <div className="bg-white flex items-center flex-grow px-5 py-2 gap-5 justify-between">
        ...
        <div className="flex space-x-5">
          <div className="hidden border-b border-black sm:flex items-center  cursor-pointer  flex-grow">
            <input
              type="text"
              className=" px-4 h-full flex-grow  outline-none"
            />
      ...
      {/* Bottom Nav */}
      <div className="bg-white hidden text-black lg:flex items-center justify-between p-4 pb-6 text-sm">
